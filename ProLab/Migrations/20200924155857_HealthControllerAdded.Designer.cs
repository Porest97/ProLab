...
namespace ProLab.Migrations
{
    ...
    [Migration("20200924155857_HealthControllerAdded")]
    partial class HealthControllerAdded
    {
            ...
            modelBuilder.Entity("ProLab.Models.DataModels.RefReceipt", b =>
                {
                    ...
                    b.Property<string>("DescriptionOthersDH1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DescriptionOthersDH2")
                        .HasColumnType("nvarchar(max)");
